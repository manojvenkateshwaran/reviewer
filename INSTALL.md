...
```
git clone https://github.com/trimble-transport/trimble.transportation.ai.reviewer.git
```
  ...
  pr_agent_job:
    ...
    steps:
      - name: PR Agent action step
        id: pragent
        uses: trimble-transport/trimble.transportation.ai.reviewer@main
        env:
...
jobs:
  pr_agent_job:
    ...
    steps:
      - name: PR Agent action step
        id: pragent
        uses: trimble-transport/trimble.transportation.ai.reviewer@v0.7
        env:
          OPENAI_KEY: ${{ secrets.OPENAI_KEY }}
          GITHUB_TOKEN: ${{ secrets.GITHUB_TOKEN }}
```
