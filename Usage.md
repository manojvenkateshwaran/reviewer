...
2. Online usage - by [commenting](https://github.com/trimble-transport/trimble.transportation.ai.reviewer/pull/229#issuecomment-1695021901) on a PR
...
`<pr_url>` is the url of the relevant PR (for example: https://github.com/trimble-transport/trimble.transportation.ai.reviewer/pull/50).
...
Online usage means invoking PR-Agent tools by [comments](https://github.com/trimble-transport/trimble.transportation.ai.reviewer/pull/229#issuecomment-1695021901) on a PR.
